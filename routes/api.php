...
use App\Http\Controllers\Api\V1\Learner\LearnerAnnouncementController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::middleware('tenant.active')->group(function (): void {
            ...
            Route::get('/tenants/{tenant}/announcements', [LearnerAnnouncementController::class, 'index']);
            Route::get('/tenants/{tenant}/announcements/{announcement}', [LearnerAnnouncementController::class, 'show']);
