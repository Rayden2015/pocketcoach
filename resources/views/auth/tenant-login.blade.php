    ...
    <div class="rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
        ...
        @if (config('services.google.client_id'))
            <a href="{{ route('auth.google.redirect', ['tenant' => $tenant->slug]) }}"
                class="mt-6 flex w-full items-center justify-center gap-2 rounded-full border border-stone-300 bg-white py-2.5 text-sm font-medium text-stone-800 hover:bg-stone-50">
