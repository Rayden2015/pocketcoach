...
@section('content')
    ...
    <form method="POST" action="{{ route('coach.programs.store', $tenant) }}" enctype="multipart/form-data" class="mt-6 space-y-4 rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
        @csrf
