...
@section('content')
    ...
    <form method="POST" action="{{ route('coach.programs.update', [$tenant, $program]) }}" enctype="multipart/form-data" class="mt-6 space-y-4 rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
        @csrf
        @method('PUT')
